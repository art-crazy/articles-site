...
export interface Media {
  id: number;
  /**
   * Коротко опишите, что изображено. Это помогает поиску и доступности.
   */
  alt: string;
  updatedAt: string;
  createdAt: string;
...
export interface Article {
  ...
  /**
   * Главное изображение статьи. Показывается на странице статьи и в карточках.
   */
...
export interface Category {
  ...
  title: string;
  /**
   * Короткая часть ссылки на страницу категории.
   */
  slug: string;
  description?: string | null;
  updatedAt: string;
...
export interface Tag {
  ...
  title: string;
  /**
   * Короткая часть ссылки на страницу тега.
   */
  slug: string;
  updatedAt: string;
  createdAt: string;
